...
class OwnerControllerTest {
    ...
    // it will set up the controller with the mocks injected into it
    @InjectMocks
    ...
    void setUp() {
        ...
        // for each test method that initializes a Mock environment for your controller
        // so we can test a lot of different interactions with it
        mockMvc = MockMvcBuilders
                .standaloneSetup(controller)
                .build();
    }

    // no longer valid and relevant
    /*@Test
    ...
    // no longer valid and relevant
    // check with different path (it should invoke the same handler method as the test above)
    /*@Test
